...
uint16_t macros[MACROS_NUM][MACRO_LEN] = {
	...
	{KC_MS_DOWN, KC_MS_LEFT, KC_NO},
	{KC_MS_DOWN, KC_MS_RIGHT, KC_NO},
};
...
uint16_t _DuckyOneMousePad[MATRIX_ROWS][KEYMAP_COLS] = {
	...
	{KC_TAB, KC_W, KC_R, KC_Y, KC_I, KC_P, KC_RBRC, KC_F2, KC_F6, KC_F9, KC_PGDOWN, KC_DELETE, KC_MS_NW, KC_LGUI, KC_MS_NE},
	{KC_CAPS, KC_S, KC_F, KC_H, KC_K, KC_SCLN, KC_ENTER, KC_NONE, KC_AUDIO_MUTE, KC_NONE, KC_F11, RAISE, KC_MS_LEFT, KC_LALT, KC_MS_RIGHT},
	{KC_LSHIFT, KC_X, KC_V, KC_N, KC_COMM, KC_SLSH, KC_RCTRL, KC_PSCREEN, KC_CALCULATOR, KC_NONE, KC_RIGHT, KC_DOWN, KC_MS_SW, KC_RALT, KC_MS_SE},
	{KC_1, KC_3, KC_5, KC_7, KC_9, KC_MINUS, KC_BSPACE, KC_F1, KC_F5, KC_F8, KC_NONE, KC_HOME, KC_MS_ACCEL0, KC_NONE, KC_MS_ACCEL2},
